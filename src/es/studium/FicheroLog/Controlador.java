...
public class Controlador implements ActionListener, WindowListener, ComponentListener
{
	...
	public Controlador(Vista v, Modelo m)
	{
		...
		this.vista.ventana.addComponentListener(this); // para que al mover la ventana veamos las medidas y el resizable comentado.
	...
	{
		System.out.println("Altura: " + this.vista.ventana.getHeight()); // y esto es para ver las medidas luego borrar al saber medida
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			modelo.guardar(vista.txtUsuario.getText(),"Has pulsado Mision");
		}
		else if (vista.btnVision.equals(e.getSource()))
		{
			modelo.guardar(vista.txtUsuario.getText(),"Has pulsado Vision");
		}
